...
begin
    ...
    -- Filtro de sinal lógico: Identifica o momento exato em que a chave foi acionada
    -- Isso resolve o problema mecânico de chaves que ficam travadas para cima (são switches, não push-buttons)
    -- forçando-as a funcionar no sistema como botões de toque rápido (pulso único)
    ...
    begin
        if rising_edge(clk) then
            -- Armazena o estado atual dos botões
